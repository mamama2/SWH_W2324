/*
  ...
  Using a ESP8266 to show the temp/hum of a DTH22 Sensor
  Martinez
*/
...
const char* ssid = "nodramalama_EXT";
const char* password = "holacompi";

#define DHTPIN 1    // Digital pin D1 connected to the DHT sensor
...
<body>
 ...
 <br>
    ...
    <span style="font-size:1.0rem;">SKETCHING mit HARDWARE - DMP - W2122</span><br>
